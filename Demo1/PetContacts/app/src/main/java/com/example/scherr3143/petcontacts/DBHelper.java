...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        + KEY_DETAIL + " TEXT, " + KEY_PHONE + " TEXT, " + KEY_IMAGEURI + " TEXT)");
    }
    ...
    public void createContact(Pet pet){
        ...
        String insert = "INSERT or replace INTO " + TABLE_NAME + "(" + KEY_NAME + ", " + KEY_DETAIL + ", " + KEY_PHONE + ", "
                + KEY_IMAGEURI + ") VALUES('" + pet.getName() + "', '" + pet.getDetail() + "', '" + pet.getPhone() + "', '"
                + pet.getPhotoURI() + "')";
    ...
    public Pet getContact(int id){
        ...
        Cursor cursor = db.query(TABLE_NAME, new String[]{KEY_ID, KEY_NAME, KEY_DETAIL, KEY_PHONE, KEY_IMAGEURI},
    ...
    public List<Pet> getAllContacts(){
        ...
        if(cursor.moveToFirst()){
            do{
                allPets.add(new Pet(Integer.parseInt(cursor.getString(0)), cursor.getString(1),cursor.getString(2),
